...
describe TransactionsController do
  ...
  let(:valid_attributes) { { "date" => "2013-06-30" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested transaction" do
        ...
        Transaction.any_instance.should_receive(:update).with({ "date" => "2013-06-30" })
        put :update, {:id => transaction.to_param, :transaction => { "date" => "2013-06-30" }}, valid_session
      end
